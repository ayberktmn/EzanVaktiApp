...
import com.ayberk.universtyapp.databinding.FragmentAnkaraAylikEzanBinding
...
@AndroidEntryPoint
class AnkaraAylikEzanFragment : Fragment() {
    private var _binding: FragmentAnkaraAylikEzanBinding? = null
    private val binding get() = _binding!!
    private lateinit var ankaraaylikezanAdapter: AnkaraaylikezanAdapter
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAnkaraAylikEzanBinding.inflate(inflater, container, false)
        val view = binding.root
        binding.rcrylerAnkaraAylik.layoutManager = LinearLayoutManager(requireContext())
        ...
        viewModel.getObserverAnkaraLiveData().observe(viewLifecycleOwner, object : Observer<AnkaraEzanSaati> {
            override fun onChanged(t: AnkaraEzanSaati?) {
                ...
                if (t != null) {
                    ankaraaylikezanAdapter.setLists(t)
                    arguments?.let {
    ...
    fun initRecyclerViews() {
        ...
        ankaraaylikezanAdapter = AnkaraaylikezanAdapter()
        binding.rcrylerAnkaraAylik.adapter = ankaraaylikezanAdapter
